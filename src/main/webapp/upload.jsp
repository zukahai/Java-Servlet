  		...
  		<div class="row">
	    	<nav aria-label="...">
			  ...
			  <c:if test="${page > 1}">
			    ...
			    <li class="page-item"><a class="page-link" href="UploadServlet?page=${ page - 1 }">${ page - 1}</a></li>
			   </c:if>
			    ...
			    <c:if test="${page < numberofpage}">
			    	<li class="page-item">
			    		<a class="page-link" href="UploadServlet?page=${ page + 1 }">${ page + 1 }</a>
			    	</li>
			    	<li class="page-item"><a class="page-link" href="UploadServlet?page=${ page + 1 }">Next</a></li>
			    </c:if>
			  </ul>
			</nav>
	    </div>
